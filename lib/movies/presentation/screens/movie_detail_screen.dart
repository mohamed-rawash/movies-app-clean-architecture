...
import '../../../core/utils/dummy_datails.dart';
...
class MovieDetailContent extends StatelessWidget {
            ...
            return CustomScrollView(
              ...
              slivers: [
                ...
                SliverPadding(
                  ...
                  sliver: _showRecommendations(state.recommendationMovies.isNotEmpty? state.recommendationMovies :recommendationDummy),
                ),
              ],
            );
  ...
  Widget _showRecommendations(List<Recommendations> recommendations) {
    print("*-* " * 10 );
